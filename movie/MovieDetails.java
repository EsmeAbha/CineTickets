...
public class MovieDetails implements ActionListener {
    ...
    public MovieDetails(Person person, int[][][][] allButtonList, Movie[] movies, Movie movie){
    ImageIcon image1 =new ImageIcon("images/moviedetails.png");
        ...
        buyticket.setBackground(new Color(60,105, 150));
        ...
        JLabel MoviePoster2= new JLabel(movie.getPosterMoviePhotos());
        ...
        JLabel Mname= new JLabel(movie.getMovieName());
        ...
        JLabel Mduration= new JLabel("Duration : "+movie.getDuration());
        ...
        JLabel Mgenre= new JLabel("Genre : "+movie.getGenre());
        ...
        JLabel Mrelease= new JLabel("Release Year : "+movie.getReleaseYear());
        ...
        JLabel Mlang= new JLabel("Language : "+movie.getLanguage());
        ...
        JLabel Mdescription= new JLabel("<html>"+movie.getDescription());
        Mdescription.setBounds(110, 810, 1600, 150);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==buyticket){
            ...
            new LocationOfHall(person, allButtonList, movies, movie);
        }
