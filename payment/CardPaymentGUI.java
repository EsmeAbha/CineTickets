...
public class CardPaymentGUI implements ActionListener {
    ...
    public CardPaymentGUI(Person p,  int n, int[] arrayOfSelectedSeats, int[][][] allButtonList2, int indexOfDate, int indexOfSeatType){
       ...
       expireField.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, new Color(10,10,10)));
        ...
        JLabel accnLabel =new JLabel();
        accnLabel.setText("Account Number");
        accnLabel.setBounds( 125,175,200,30);
        accnLabel.setFont(new Font("BankGothic Md BT", Font.PLAIN, 18));
      ...
      accHolderNameField.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, new Color(10,10,10)));
        ...
        ImageIcon image1 =new ImageIcon("images/logo.png");
